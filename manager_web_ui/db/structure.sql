...
--
-- Name: payment_requests_to_review; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.payment_requests_to_review (
...
--
-- Name: payment_requests_to_review payment_requests_to_review_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payment_requests_to_review
    ADD CONSTRAINT payment_requests_to_review_pkey PRIMARY KEY (id);
